...
app.controller('PartiesCtrl', ['$scope', 'parties', 'party', 'auth',
function($scope, parties, party, auth) {
	$scope.party = party;
	$scope.isLoggedIn = auth.isLoggedIn;
	...
	$scope.skip = function(comment) {
		posts.skipRequest(party, request);
	};
